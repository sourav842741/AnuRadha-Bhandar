...
export default async function UserDashboard({ searchParams }: Props) {
  ...
  return (
    <>
      ...
      {/* Flash Deals - Shows active deals with countdown */}
      <FlashDeals />
      ...
      <div className="px-4 sm:px-6 md:px-0 w-full md:w-[92%] mx-auto mt-6">
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-10 gap-y-6 gap-x-4">
          {categoryData.map((cat, index) => (
            ...
            >
              <div
                className="w-20 h-20 sm:w-22 sm:h-22 bg-white rounded-2xl 
              ...
              <p
                className="text-[11px] sm:text-xs text-center mt-2 
      ...
      <section
        className="w-[92%] md:w-[80%] mx-auto mt-10 
...
shadow-sm p-6"
      ...
      {recommendedProducts.length > 0 && (
        <section
          className="w-[92%] md:w-[80%] mx-auto mt-14 
          ...
          return (
            <div key={index} id={cat} className="mb-16 scroll-mt-32">
              <div className="flex justify-between items-center mb-5">
                <h2 className="text-2xl font-bold text-green-700">{cat}</h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
          ...
          <div className="w-full md:w-[60%]">
            ...
            <p className="text-gray-600 mb-3">
              Fresh groceries delivered fast. Visit our store or order online
              anytime.
            </p>

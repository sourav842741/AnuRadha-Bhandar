...
- [🛒 SnapCart — Hyperlocal Grocery Delivery Platform](#-snapcart--hyperlocal-grocery-delivery-platform)
  - [✨ Features](#-features)
    - [👤 User](#-user)
    - [🛠️ Admin](#️-admin)
  ...
  - [🚀 Getting Started](#-getting-started)
    ...
    - [2. Set up the Next.js app (`snapcart/`)](#2-set-up-the-nextjs-app-snapcart)
    - [3. Set up the Socket Server (`socketServer/`)](#3-set-up-the-socket-server-socketserver)
    - [4. Run both servers](#4-run-both-servers)
  - [🔐 Environment Variables](#-environment-variables)
    - [Next.js app — `.env.local`](#nextjs-app--envlocal)
    - [Socket server — `.env`](#socket-server--env)
  - [🔑 How to get the API keys](#-how-to-get-the-api-keys)
  - [👥 Roles \& Access](#-roles--access)
  - [📡 API Endpoints](#-api-endpoints)
  - [🔌 Socket Events](#-socket-events)
  - [💳 Payments (Razorpay Test Mode)](#-payments-razorpay-test-mode)
...
Fill in your real credentials in `.env.local` (see [Environment Variables](#-environment-variables)).
